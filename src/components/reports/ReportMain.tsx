...
export default function ReportMain({
  ...
  if (isGenerating) {
    return (
      ...
      >
        ...
        <h1 className="text-[26px] lg:text-[28px] font-bold text-[#1A1A1A] leading-[1.4] mb-6">
          {title || "보고서"}
        </h1>
  ...
  if (isFailed) {
    return (
      ...
      >
        <p className="text-[14px] text-[#999] mb-1">상담 보고서</p>
        <h1 className="text-[26px] lg:text-[28px] font-bold text-[#1A1A1A] leading-[1.4] mb-4">
          {title || "보고서"}
        </h1>
        <p className="text-[16px] text-[#333] mb-2">보고서 생성에 실패했어요.</p>
        {errorMessage && (
  ...
  if (isDone && !reportJson && !reportJsonParseError) {
    return (
      ...
      >
        ...
        <p className="text-[16px] text-[#666]">보고서를 생성 중이에요. 잠시 후 다시 확인해 주세요.</p>
      </article>
    );
  }
  ...
  if (isDone && reportJsonParseError) {
    return (
      ...
      >
        ...
        <p className="text-[16px] text-[#666]">보고서 데이터를 불러오지 못했어요.</p>
      </article>
    );
  }

...
[구성 원칙]
- detailed_notes는 요약이 아니라, 흩어진 transcript를 “입시 의사결정 관점”으로 재구성함.
...
- 상담에서 나온 내용을 “입시 판단 포인트(유불리/리스크/조건/대안/카드 구성)” 기준으로 재구성함.
- 다음을 우선 포함함:
  - 지원 가능/불가 판단의 근거
  - 리스크 요인(감점, 반영비, 변표 등)과 대응
  - 지원 카드 조합(상향/적정/안정) 또는 제외 전략
  - 확인해야 할 추가 변수(추정 불가한 부분은 ‘추정 불가함’으로 명시)
- 금지: 감정/상담장 분위기/대화 흐름 묘사, “학생은 ~했다” 반복, “~로 평가됨/권장됨” 남발
